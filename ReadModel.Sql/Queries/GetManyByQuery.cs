...
namespace Spritely.ReadModel.Sql
{
        ...
        where TDatabase : ReadModelDatabase<TDatabase>
    {
        ...
        public GetManyByQueryHandler(ReadModelDatabase<TDatabase> readModelDatabase, JsonSerializerSettings jsonSerializerSettings = null)
        {
        ...
        public IReadOnlyCollection<TResult> Handle(GetManyByQuery<TResult> query)
        {
            ...
            {
                result = connection
                    .Query(string.Format("select * from [{0}] where {1}", query.ModelType, queryParameters), query)
